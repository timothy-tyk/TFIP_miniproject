...
public class RoomRepository {
  ...
  public final String INSERT_ROOM_SQL="INSERT INTO rooms (name, description, user_count, room_id, active) VALUES (?,?,?,?,?)";
  ...
  public Room insertRoom(Room room){
    Integer inserted =jdbcTemplate.update(INSERT_ROOM_SQL, room.getName(), room.getDescription(), room.getUserCount(), room.getRoomId(), room.isActive());
    if(inserted>0){
